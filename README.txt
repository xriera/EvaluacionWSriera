...
a persistence unit "EvaluacionWSrieraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSriera\pom.xml":
...
artifact ("EvaluacionWSriera.war") is already built. You can build
